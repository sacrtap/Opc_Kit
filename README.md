...
- **Text entry is delegated, never generated by Jev** — Jev picks *which* field; a small free LLM generates the value; `fill` never submits, so consequential steps stay with you
